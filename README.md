...
See [catalog.yaml](src/main/resources/catalog.yaml) and [catalog.json](src/main/resources/catalog.json) for examples.
...
[health-checks.yaml](src/main/resources/health-checks.yaml) for an annotated example.
