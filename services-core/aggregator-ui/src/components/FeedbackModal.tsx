    ...
    >
      ...
      >
        ...
        <p className="feedback-note">
          Your message is stored as-is so I can read it later. I cannot reply
          directly, but your feedback helps a lot. Thank you for taking the
          time.
        </p>
        <label className="feedback-label" htmlFor="feedback-textarea">
          Your message
        </label>
        <textarea
